...
test.describe('Chromium Browser Player Subtitles E2E Suite', () => {
  test('should populate #sub-select dropdown menu with bundled and external subtitles in Chromium player', async ({ page }) => {
